...
openssl req -new -sha256 -key root/root.key -out root/root.csr -subj "/C=US/ST=Colorado/L=Colorado Springs/O=Platform1/OU=Iron Bank/CN=ironbank.dsop.io/emailAddress=ironbank@dsop.io"
...
openssl req -new -sha256 -key delegation/delegation.key -out delegation/delegation.csr -subj "/C=US/ST=Colorado/L=Colorado Springs/O=Platform1/OU=Iron Bank/CN=ironbank.dsop.io/emailAddress=ironbank@dsop.io"
