...
sys.path.append(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "scripts/modules"))
...
def main():
    ...
    # )
    vat_response = _get_vat_response(os.environ["IMAGE_NAME"], os.environ["IMAGE_VERSION"])
