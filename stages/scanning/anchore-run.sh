...
# Install anchore-cli
# TODO: Install the anchore-cli in the container
pip3 install --user --upgrade anchorecli

# The anchore-cli is not installed along the normal path so set the path appropriately.
# TODO: Configure the anchore-cli path in the container
...
"${ANCHORE_CLI_PATH}/anchore-cli" image add --dockerfile ./Dockerfile --force "${IMAGE_NAME}"
