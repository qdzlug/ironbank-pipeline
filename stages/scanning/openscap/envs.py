...
def ci_var(func=None , *, default: str = ""):
    ...
    """
    if func:
        return property(lambda instance: fetch_env_var(func.__name__, func.__doc__, default))
    
    return lambda func: property(lambda instance: fetch_env_var(func.__name__, func.__doc__, default))
