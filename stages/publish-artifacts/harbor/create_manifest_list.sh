...
for tag in "${tags_array[@]}"; do 
  ...
  echo "podman manifest add $REGISTRY_PUBLISH_URL_ARM64/$IMAGE_NAME_ARM64:$tag docker://$REGISTRY_PUBLISH_URL_ARM64/$IMAGE_NAME_ARM64@$DIGEST_TO_SCAN_X86 --authfile $DOCKER_AUTH_FILE_PUBLISH"
  ...
  echo "podman manifest add $REGISTRY_PUBLISH_URL_ARM64/$IMAGE_NAME_ARM64:$tag docker://$REGISTRY_PUBLISH_URL_ARM64/$IMAGE_NAME_ARM64@$DIGEST_TO_SCAN_ARM64 --authfile $DOCKER_AUTH_FILE_PUBLISH"
  ...
  echo "podman manifest push --all $REGISTRY_PUBLISH_URL_ARM64/$IMAGE_NAME_ARM64:$tag --authfile $DOCKER_AUTH_FILE_PUBLISH"
