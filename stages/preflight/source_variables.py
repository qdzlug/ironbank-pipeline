    ...
    for type in content:
        if type == "path":
            try:
                ...
                print(
                    "There was an issue with retrieving the image path in description.yaml",
                    file=sys.stderr,
                )
        ...
        if type == "tags":
            try:
                ...
                print(
                    "There was an issue sourcing the tag/image version from description.yaml",
                    file=sys.stderr,
                )
        ...
        if type == "args":
            try:
                ...
                print(
                    "There was an issue sourcing the args from description.yaml",
                    file=sys.stderr,
                )
        ...
        if type == "labels":
            try:
                ...
                print(
                    "There was an issue sourcing the labels from description.yaml",
                    file=sys.stderr,
                )
