...
class TestParse:
   ...
   def test_parse_csvs_except(self, monkeypatch):
      ...
      monkeypatch.setattr(vat_import, 'parse_twistlock_security', mock_parse_twistlock_security)
      monkeypatch.setattr(vat_import, 'parse_anchore_security', mock_parse_anchore_security)
      monkeypatch.setattr(vat_import, 'parse_anchore_compliance', mock_parse_anchore_compliance)
      monkeypatch.setattr(vat_import, 'parse_oscap_security', mock_parse_oscap_security)
      monkeypatch.setattr(vat_import, 'parse_oscap_compliance', mock_parse_oscap_compliance)
