...
def test_parse_twistlock_security():
   ...
   assert rslt.at[0,'description'] == 'Apache Commons FileUpload before 1.3.3 DiskFileItem File Manipulation Remote Code Execution', "description"
   assert rslt.at[0,'package'] == 'commons-fileupload_commons-fileupload-1.3.1-jenkins-2', "package"
